...
SECRET_KEY = 'django-insecure-cji^0q3i-=kwd$pnl6(j5(p6!0fu9pf=0bb8rv@&lj+(_be19r'
...
INSTALLED_APPS = [
    'jazzmin',
    'intern_app',
 #   'intern_app.apps.InternAppConfig',
...
LOGIN_URL = 'intern_app:login'
AUTH_USER_MODEL = 'intern_app.PersonUser'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {'name':'Anasayfa',"url":'admin:index',"permissions":['auth.view.user']},
        {"name": "Siteye Geri Dön",  "url": "intern_app:index", "permissions": ["auth.view_user"]},
